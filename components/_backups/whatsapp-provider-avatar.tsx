...
interface WhatsappAvatarProps extends React.ComponentPropsWithoutRef<
  typeof Avatar
> {
  provider_name: string
}

export const WhatsappProviderAvatar = React.forwardRef<
  ...
  return (
    ...
    >
      ...
      <AvatarFallback className="text-xs">
        {provider_name?.slice(0, 2)?.toUpperCase()}
      </AvatarFallback>
    </Avatar>
  )
})
