...
export const MiniCalendar = ({
  ...
  const [selectedDate, setSelectedDate] = useControllableState<Date | null | undefined>({
    prop: value,
  ...
  return (
    <MiniCalendarContext.Provider value={contextValue}>
      <div className={cn('flex items-center justify-center gap-2 rounded-lg border p-2', className)} {...props}>
        {children}
      </div>
