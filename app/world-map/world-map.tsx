...
export function showTooltip(e: any, text: any) {
  let tooltip = document.getElementById("world-map-tooltip") as HTMLElement
...
export function hideTooltip() {
  var tooltip = document.getElementById("world-map-tooltip") as HTMLElement
  tooltip.style.display = "none"
}

interface SVGMap extends React.SVGProps<SVGSVGElement> {
  visited: string[]
}

const WorldMap = ({ visited: _visited, className, ...props }: SVGMap) => {
  ...
  return (
    <React.Fragment>
      <div
        ...
        className="absolute z-50 hidden w-fit max-w-xs origin-(--transform-origin) rounded-md bg-foreground px-3 py-1.5 text-xs text-background data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=delayed-open]:animate-in data-[state=delayed-open]:fade-in-0 data-[state=delayed-open]:zoom-in-95 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95"
      />
      <svg
        viewBox="0 0 2000 857"
        style={
          {
            "--visited-light": "var(--color-lime-300)",
            "--visited-dark": "var(--color-lime-800)",
            "--lived-light": "var(--color-sky-300)",
            "--lived-dark": "var(--color-sky-800)",
          } as React.CSSProperties
        }
        className={cn(
          "cursor-default fill-muted stroke-background stroke-[0.5]",
          "[&>g]:hover:fill-muted-foreground/50 [&>path]:hover:fill-muted-foreground/50",
          "[&>g]:data-[visited=true]:fill-(--visited-light) [&>path]:data-[visited=true]:fill-(--visited-light)",
          "dark:[&>g]:data-[visited=true]:fill-(--visited-dark) dark:[&>path]:data-[visited=true]:fill-(--visited-dark)",
          "[&>g]:data-[lived=true]:fill-(--lived-light)! [&>path]:data-[lived=true]:fill-(--lived-light)!",
          "dark:[&>g]:data-[lived=true]:fill-(--lived-dark)! dark:[&>path]:data-[lived=true]:fill-(--lived-dark)!",
          className
        )}
        {...props}
      >
        ...
        <path
          ...
          data-lived={true}
          onMouseMove={(e) => showTooltip(e, "Brazil")}
          onMouseOut={() => hideTooltip()}
        ></path>
        <path
        ...
        <path
          ...
          data-lived="true"
          onMouseMove={(e) => showTooltip(e, "Sweden")}
          onMouseOut={() => hideTooltip()}
        ></path>
        <path
        ...
        <g
          ...
          onMouseMove={(e) =>
            showTooltip(e, "Bonaire, Sint Eustatius and Saba")
          }
          onMouseOut={() => hideTooltip()}
          id="535"
        >
